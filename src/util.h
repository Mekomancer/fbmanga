...
//  static_assert((val & ~((1<<cur)-1))==0, "Input bitdepth must be greater than or eqaul to than real bitdepth");
//  static_assert(~((T) 0) >= ((1<<cur)-1), "The number of bits in the input type must be greater than input bitdepth");
